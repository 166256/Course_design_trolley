...
#define MPU_SAMPLE_RATE_REG		0X19	//采样频率分频器  SAMPLE_RATE= Internal_Sample_Rate / (1 + SMPLRT_DIV)
#define MPU_CFG_REG				0X1A	//配置寄存器
#define MPU_GYRO_CFG_REG		0X1B	//陀螺仪配置寄存器，00 = +250dps，01= +500 dps,10 = +1000 dps,11 = +2000 dps
...
u8 MPU_Write_Len(u8 addr,u8 reg,u8 len,u8 *buf);  //连续写
u8 MPU_Read_Len(u8 addr,u8 reg,u8 len,u8 *buf);  //IIC连续读
short MPU_Get_Temperature(void);      //读取温度
